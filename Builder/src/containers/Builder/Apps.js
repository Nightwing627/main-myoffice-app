    ...
    <div className="main-panel" style={{ width: '100%'}}>
        ...
        <div className="container-fluid">
            ...
            <Tile 
              ...
              link={Config.isFree||this.checkIsSuperAdmin()?"/#/create":this.state.appsMade<this.state.appsAllowed&&this.licenseCodeValidation()?"/#/create":null}
              onClick={!Config.isFree||!this.checkIsSuperAdmin()?this.manageButtonCreateApp:!(this.state.appsMade<this.state.appsAllowed)||!this.licenseCodeValidation()?this.manageButtonCreateApp:null}
              isIcon={true}
